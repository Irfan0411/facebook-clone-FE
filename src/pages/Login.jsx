    ...
    return (
        <div className='container px-3 mx-auto w-full'>
            ...
            <form>
                ...
                <button className='w-full h-11 my-3 bg-primary rounded-md text-white font-bold'>Masuk</button>
            </form>
            <div className='mx-auto w-fit'>
                <Link to='/' className='text-blue-700'>Lupa Kata Sandi?</Link>
            </div>
            ...
            <div className='w-fit mx-auto mb-28'>
                <button className='border w-[285px] h-9 font-semibold'>Buat akun baru</button>
            </div>
            <footer>
